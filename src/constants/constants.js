...
const aboutMeText = [
  "I'm a frontend developer with a passion for creating meaningful and accessible web applications. I enjoy working with Javascript, React.js, Framer Motion, Node.js and MongoDB, and I'm curious and eager to learn new technologies. I use my imagination and creativity everywhere in my life and I'm always looking for new ways to express myself. Crafting beautiful and functional websites is one of my favorite ways to do so.",
  ...
  "Beyond my work, I enjoy exploring new places, as well as gazing up at the night sky. I like delving into local history, appreciating local architecture and indulging in amateur astronomy. I've found immense joy and fulfillment in my long-standing involvement in choirs. Additionally, my transformative journey into yoga has had a profound impact on both my mind and body. The positive energy I derive from choir singing and yoga serves as a healing force, enriching my life further. Nature, in all its beauty, feels like a second home to me. Whether I'm following mountain trails or tending to my beloved flower and vegetable garden, I relish every moment spent outdoors.",
